  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-opacity-50 backdrop-blur-lg shadow-sm": ""}`}>
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"}`}>
            ...
            <li><a className='font-Ovo' href='#certification'>Certifications</a></li>
        ...
        {/* --------------------- mobile menu ------------------- */}
        <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 border-0
        w-64 z-50 h-screen bg-gray-200 transition duration-500'>
          ...
          <div className='absolute right-6 top-6' onClick={closeMenu}>
            ...
            <li><a className='font-Ovo' onClick={closeMenu} href='#certification'>Certifications</a></li>
